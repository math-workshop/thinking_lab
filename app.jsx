        ...
        {authors.map((a) => (
          <div key={a.last} className="mmm-card" style={{ padding: 24, display:'flex', flexDirection:'column', gap: 14 }}>
            <div style={{ display:'flex', gap: 14, alignItems:'center' }}>
              {a.photo
                ? <img src={a.photo} alt={`${a.last} ${a.first} ${a.patr}`} style={{ flex:'0 0 96px', width: 96, height: 96, borderRadius:'50%', objectFit:'cover', background: a.soft, boxShadow:`0 0 0 2px var(--paper), 0 0 0 4px ${a.color}` }}/>
                : <div style={{ flex:'0 0 96px', width: 96, height: 96, borderRadius:'50%', background: a.soft, display:'grid', placeItems:'center', fontFamily:'var(--serif)', fontSize: 38, fontWeight: 700, color: a.color }}>{a.initial}</div>}
              <div>
