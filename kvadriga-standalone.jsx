  ...
  return (
    <div className="kv-scene kv-scene-room" style={{ background:'linear-gradient(180deg,#f0e8d4 0%,#d8c8a0 100%)', height:'auto', padding:'14px 10px' }}>
      <div style={{ display:'flex', flexDirection:'column', gap: 10 }}>
        <img src={window.__resources?.kvStrip1 || "kvadriga-strip1.jpg"} alt="Телеграфная лента I — пропали 1-я и 3-я буквы каждого слова" style={{ width:'100%', display:'block', borderRadius: 4 }}/>
        <img src={window.__resources?.kvStrip2 || "kvadriga-strip2.jpg"} alt="Телеграфная лента II — пропали 2-я и 6-я буквы каждого слова" style={{ width:'100%', display:'block', borderRadius: 4 }}/>
      </div>
    </div>
  );
}
  ...
  return (
    <div style={{ maxWidth: 900, margin:'0 auto', display:'flex', flexDirection:'column', gap: 'var(--pad-lg)' }}>
      ...
      <header className="mmm-fade-up" style={{ background:'linear-gradient(135deg, #f4dca8 0%, #e0b878 100%)', padding: '24px 200px 24px 26px', borderRadius: 12, border:'1.5px solid var(--line)', position:'relative', overflow:'hidden', minHeight: 180 }}>
        <img src={window.__resources?.kvLogo || "kvadriga-logo.png"} alt="Логотип олимпиады «Квадрига»" style={{ position:'absolute', right: 18, top: 18, width: 132, height: 132, borderRadius: '50%', objectFit: 'cover', boxShadow: '0 2px 10px rgba(60,40,20,.15)' }}/>
  ...
  const seasons = [
    {
      ...
      cover: (
        <svg viewBox="0 0 220 220" style={{ width:'100%', height:'100%' }}>
          ...
          {[0,1,2].map(r => [0,1,2].map(c => <rect key={'m'+r+'-'+c} x={40+c*46} y={106+r*16} width="45" height="15" fill="#9aa86a" stroke="#5a6a32" strokeWidth="1.5"/>))}
  ...
  return (
    <div style={{ maxWidth: 1100, margin:'0 auto', display:'flex', flexDirection:'column', gap: 'var(--pad-lg)' }}>
      ...
      <header className="mmm-fade-up" style={{ background:'linear-gradient(135deg, #f4dca8 0%, #e0b878 100%)', padding: '28px 30px', borderRadius: 12, border:'1.5px solid var(--line)', position:'relative', overflow:'hidden' }}>
        <img src={window.__resources?.kvLogo || "kvadriga-logo.png"} alt="Логотип олимпиады «Квадрига»" style={{ position:'absolute', right: 22, top: 22, width: 120, height: 120, borderRadius: '50%', objectFit: 'cover', boxShadow: '0 2px 10px rgba(60,40,20,.15)' }}/>
      ...
      {role === 'teacher' && (
        <div className="mmm-card" style={{ padding: 18, background:'var(--paper-2)', borderLeft:'3px solid var(--olive)' }}>
          ...
          <div style={{ display:'flex', gap: 8, flexWrap:'wrap' }}>
            <a className="mmm-btn ghost" href={window.__resources?.kvEtap1Pdf || "kvadriga-etap1-telegramma.pdf"} target="_blank" rel="noopener" style={{ fontSize: 13, padding:'8px 14px', textDecoration:'none' }}>⤓ Этап 1. Телеграмма (PDF)</a>
            <a className="mmm-btn ghost" href={window.__resources?.kvEtap2Pdf || "kvadriga-etap2-zadacha.pdf"} target="_blank" rel="noopener" style={{ fontSize: 13, padding:'8px 14px', textDecoration:'none' }}>⤓ Этап 2. Условие задачи (PDF)</a>
          </div>
        </div>
      )}
    </div>
